...
<section class="games">
  ...
  <div class="project-grid container">
    ...
    {% projectcard "AI Formations", "2021 (2 days)", "Research on Coordinated Group Movement for AI in games. Researched AI leadership roles, pathfinding solutions and RTS gameplay using Unity3D and C#.", "https://github.com/EezehDev/AI-Formations", "aiformations.png" %}
