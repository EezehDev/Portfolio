...
<section class="games">
  ...
  <div class="project-grid container">
    ...
    {% projectcard "RideTheChains", "2021 (48 hours)", "MashUp Game Jam 2 submission made with a couple of friends, worked on the endless loop system and helped with combat behavior, art assets using Blender and Unity.", "https://tomstevens.itch.io/ridethechains", "/img/ridethechains.png" %}
